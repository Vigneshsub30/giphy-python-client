...
func TrendinggifsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/gifs/trending%s", cfg.BaseURL, queryString)
...
func CreateTrendinggifsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_gifs_trending",
		mcp.WithDescription("Trending GIFs"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    TrendinggifsHandler(cfg),
	}
}
