...
func RandomgifHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/gifs/random%s", cfg.BaseURL, queryString)
...
func CreateRandomgifTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_gifs_random",
		mcp.WithDescription("Random GIF"),
