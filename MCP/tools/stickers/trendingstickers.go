...
func TrendingstickersHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/stickers/trending%s", cfg.BaseURL, queryString)
...
func CreateTrendingstickersTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_stickers_trending",
		mcp.WithDescription("Trending Stickers"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    TrendingstickersHandler(cfg),
	}
}
